      ...
      <div class="row me animated fadeIn">
        <div class="col-md-offset-6 col-sm-offset-6 col-xs-7 col-sm-6">
          ...
          <div class="animated fadeIn">
            ...
            <div class="tagline3b">Bonafide Certificate
              <br> Transcripts
              <br> Grade Card
              <br> Proof of Enrollment
              <br>
            </div>
    ...
    <div class="row max">
      ...
      <div class="text-center">
        <div class="desc">
          ...
          <p>we provide educational solution.</p>
        </div>
      </div>
    ...
    <div class="row section-banner">
      <div class="col-md-offset-2 col-md-7 text-center">
        <div>
          ...
          <span class="section-title portfolio">Our Product</span>
          <span class="line portfolio"></span>
        </div>
      </div>
    </div>
...
<div class="text-center">
  <div class="desc">
   <p> In many university students or alumni are facing problem to get documents like Transcripts, Bona-fide Certificate, Proof of Enrollment, Grade Card of any semester due to holiday in institute or student is migrated away from the university,At this student want document without going anywhere, So our team planning to work on An online portal from where a student can directly request for documents like Transcripts, Bona-fide Certificate, Proof of Enrollment, Grade Card of any semester, etc. And university will post document as per requested by student.</p>
  </div>
</div>
